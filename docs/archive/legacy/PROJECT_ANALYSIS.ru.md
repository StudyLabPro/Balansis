...
- **Тесты:** 673 тестовые функции, 85%+ покрытие, проверка алгебраических аксиом
...
Проект имеет солидное математическое основание (доказанные алгебраические свойства), хорошее качество кода (85%+ тестов, strict mypy, pre-commit) и широкий потенциал применения — от глубокого обучения до финансов и физических симуляций.
